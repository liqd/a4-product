...
class SpeakupIdeaExportView(PermissionRequiredMixin,
    ...
    permission_required = 'a4_candy_speakup.moderate_speakup'
...
class SpeakupIdeaCommentExportView(PermissionRequiredMixin,
                                   a4_export_mixins.ExportModelFieldsMixin,
                                   a4_export_mixins.ItemExportWithLinkMixin,
                                   a4_export_mixins.ItemExportWithRatesMixin,
                                   a4_export_views.BaseItemExportView):
    ...
    def get_queryset(self):
        comments = (Comment.objects.filter(speakup__module=self.module)
                    | Comment.objects.filter(
                    parent_comment__speakup__module=self.module))
